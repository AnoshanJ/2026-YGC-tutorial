...
| [triage-agent](triage-agent/) | CrewAI | External (run locally; pushes OTEL to AM) | Multi-agent showcase: classifier → router → drafter → verifier. Hierarchical trace shape. |
