# 2026 AUS AI Tutorial

Home for AI agent tutorials — each numbered `Lab-NN/` directory is a self-contained tutorial with its own agents, tooling, and notes.
...
Each lab is self-contained — `cd` in and follow that lab's `README.md`.
